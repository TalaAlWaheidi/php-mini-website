      ...
      *** TOPBAR ***
      ...
      -->
        <div id="top">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 offer mb-3 mb-lg-0"><a href="#" class="btn btn-danger btn-sm">Offer of the day</a><a href="#" class="ml-1">Get flat 35% off on orders over $50!</a></div>
                    <div class="col-lg-6 text-center text-lg-right">
                        <ul class="menu list-inline mb-0">
                            <li class="list-inline-item"><a href="../index.php">Login</a></li>
                            <!-- <li class="list-inline-item"><a href="../index.php" data-toggle="modal" data-target="#login-modal">Login</a></li> بخليها تنزل تحت -->
                            <li class="list-inline-item"><a href="../index.php">Register</a></li>
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container"><a href="index.html" class="navbar-brand home"><img id="websitelogo" src="../admin/images/icon/logoteal.png" alt="Obaju logo" class="d-none d-md-inline-block"><img src="img/logo-small.png" alt="Obaju logo" class="d-inline-block d-md-none"><span class="sr-only">Obaju - go to homepage</span></a>
    ...
    <div id="all">
        <div id="content">
            ...
            ?>
                <div class="clearfix card" style="width: 30.5%; display:inline-block; margin:1%;">
                    <img class="w-100 p-3" src="../admin/<?php echo $row['category_img'] ?>" alt="">
                    <div class="card-body">
                        <h4 class="card-title" style="text-align:center;"><?php echo $row['category_name'] ?></h4>
                    </div>
                    <div class="card-footer text-center">
                        <a href="<?php echo $row['category_name'] ?>.php" class="btn btn-primary">Find Out More!</a>
                    </div>
                </div>
            <?php
            };
        ...
        *** HOT PRODUCT SLIDESHOW ***
        ...
        -->
            ...
            while ($row = mysqli_fetch_assoc($result)) {
            ?>
                <div class="clearfix card" style="width: 31.2%; display:inline-block; margin:15px;">
                    <img class="w-100 p-3" src="../admin/<?php echo $row['product_image']; ?>" alt="">
                    <div class="card-body">
                        <h4 class="card-title" style="text-align:center;"><?php echo $row['category_name']; ?></h4>
                        <p class="card-title" style="text-align:center;"><?php echo $row['product_name']; ?></p>
                        <p class="card-title" style="text-align:center;"><?php echo $row['product_price']; ?></p>
                    </div>
                    <div class="card-footer text-center">
                        <a href="<?php echo $row['category_name']; ?>.php" class="btn btn-primary">Find Out More!</a>
                    </div>
